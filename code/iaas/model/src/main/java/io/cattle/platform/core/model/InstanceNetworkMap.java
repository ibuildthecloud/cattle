...
public interface InstanceNetworkMap extends java.io.Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface InstanceNetworkMap
	 */
	public void from(io.cattle.platform.core.model.InstanceNetworkMap from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface InstanceNetworkMap
	 */
